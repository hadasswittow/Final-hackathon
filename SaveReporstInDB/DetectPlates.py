...
def detectPlatesInScene(imgOriginalScene):
    ...
    if license_plate_detector.showSteps == True: # show steps #######################################################
    ...
    if license_plate_detector.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, license_plate_detector.SCALAR_WHITE)
    ...
    if license_plate_detector.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), license_plate_detector.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), license_plate_detector.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), license_plate_detector.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), license_plate_detector.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if license_plate_detector.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, license_plate_detector.SCALAR_WHITE)
        # end if # show steps #####################################################################
